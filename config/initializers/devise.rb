...
Devise.setup do |config|
  ...
  config.mailer_sender = "josh@tubedepot.com"
  ...
  # config.pepper = "3d90384a038f0cb21000960953886c54fda85ebabc61b6785c059e7a21b48e58885688e6266273efc507375f1dbeb84c919a7925a96d69eea92882f908864330"
  ...
  # If true, authentication through token does not store user in session and 
  # needs to be supplied on each request. Useful if you are using the token as 
  # API token.
